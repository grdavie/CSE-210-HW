...
public class Entry
{
    ...
    public string _randomPrompt; //the string returned by the ReturnRandomPrompt(List<string> _prompt) method of the PromptGenerator object should be assigned as the value for this attribute
